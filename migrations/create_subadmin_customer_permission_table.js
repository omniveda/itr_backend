...
async function createSubadminCustomerPermissionTable() {
  ...
  try {
    ...
    console.log('Subadmin customer permission table created or already exists.');
  } catch (error) {
    console.error('Error creating subadmin customer permission table:', error);
  } finally {
    await connection.end();
  }
}

createSubadminCustomerPermissionTable();
